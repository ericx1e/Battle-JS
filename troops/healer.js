function Healer(x, y, team) {
    ...
    this.update = function (allies, foes) {
        ...
        let targetDist = distSquared(this.pos.x, this.pos.y, this.target.pos.x, this.target.pos.y) * distSquared(this.pos.x, this.pos.y, this.target.pos.x, this.target.pos.y)

        allies.forEach(ally => {
            if (!ally.isDead) {
                let dist = distSquared(this.pos.x, this.pos.y, ally.pos.x, ally.pos.y)
                if (dist < targetDist) {
                    this.target = ally
                    targetDist = dist
                }
        ...
        if (targetDist < this.attackRange * this.attackRange) {
